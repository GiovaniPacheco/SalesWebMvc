...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller seller1 = new Seller(1, "Alan Turing", "alan.turing@gmail.com", new DateTime(1912, 06, 23), 6500.00, computers);
            Seller seller2 = new Seller(2, "Obi-Wan Kenobi", "obiwan.kenobi@gmail.com", new DateTime(1980, 12, 25), 3500.00, electronics);
            Seller seller3 = new Seller(5, "Tony Stark", "sextafeira@starkindustries.com", new DateTime(1990, 09, 5), 3000.00, computers);
            Seller seller4 = new Seller(4, "Luke Skywalker", "luke.skywalker@gmail.com", new DateTime(1995, 01, 15), 2500.00, books);
            Seller seller5 = new Seller(3, "Leia Organa", "leia.organa@gmail.com", new DateTime(1995, 01, 15), 2500.00, fashion);
            Seller seller6 = new Seller(6, "Marie Curie", "mariecurie@gmail.com", new DateTime(1867, 11, 7), 5500.00, electronics);
